...
class BookedAppointmentCard extends StatelessWidget {
  final String image;
        ...
        children: [
          Container(
            decoration: BoxDecoration(
              ...
              border: Border.all(color: Color(0xFFFF9A17), width: 3),
            ),
          ...
          Column(
            ...
            children: [
              HeaderFour(text: clientName),
              HeaderFive(text: orderTime),
            ],
          ),
          Spacer(),
          Image.asset('assets/Frame 1000006492.png'),
        ],
      ),
    );
  }
